...
> 無需編譯，下載 APK 即可安裝體驗完整功能。

**系統需求：** Android 7.0 以上（API 24+）

### 安裝步驟

1. 下載 [`CineGraph.apk`](apk/CineGraph.apk)
2. 在 Android 裝置上開啟下載的檔案
3. 若出現「來自不明來源」提示，至**設定 → 安全性**允許安裝即可
4. 安裝完成後開啟 App，可以訪客身分瀏覽，或使用免費 [TMDB 帳號](https://www.themoviedb.org/signup)登入以解鎖收藏功能
